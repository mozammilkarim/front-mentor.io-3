...
const Footer = () => {
    return (
        <footer className='bg-[#151515] text-white py-[80px] px-10 flex flex-col sm:flex-row gap-5 sm:gap-0 justify-between items-center'>
